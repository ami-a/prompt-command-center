...
;
;     #Include E:\Prpjects\2026\PCC\scripts\pcc.ahk
;
...
; (above the script's first Return). Appended to the end of a001.ahk they are
; unreachable, the variables stay empty, and `Run` is handed an empty command —
; which surfaces as "failed to start PCC". Locals inside a function have no such
; dependency on where the file is pasted.
